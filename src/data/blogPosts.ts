...
export interface BlogPostData {
    ...
    readTime: string;
    author: Author;
    authors?: Author[]; // Additional authors for sidebar
    ...
    link?: string; // External link for papers
    venue?: string;
...
export const blogPosts: BlogPostData[] = [
    {
        ...
        content: [
            ...
            },
            {
                ...
                content: {
                    ...
                    rows: [
                        ...
                        { cells: ['Gemini 3.0 Pro (API High Thinking) NEW', '57%', '28.5'], highlight: true, highlightColor: 'brand-blue' },
            ...
            {
                type: 'heading',
                content: 'An Example where Gemini 3.0 outperformed prior SOTA'
            },
            {
                type: 'text',
